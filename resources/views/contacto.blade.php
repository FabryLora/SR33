        ...
        <div class="flex flex-col gap-8 md:flex-row md:gap-0">
            ...
            <form id="contactForm" method="POST" action="{{ route('send.contact') }}"
                ...
                <div class="flex flex-col gap-2 sm:gap-3">
                    <label for="name" class="text-base ">Nombre y Apellido*</label>
                ...
                <div class="flex flex-col gap-2 sm:gap-3">
                    <label for="celular" class="text-base ">Celular*</label>
                ...
                <div class="flex flex-col gap-2 sm:gap-3">
                    <label for="empresa" class="text-base ">Empresa</label>
                ...
                <div class="flex flex-col gap-2  sm:gap-3">
                    <label for="mensaje" class="text-base ">Mensaje</label>
                ...
                <div class="flex flex-col justify-end gap-3 ">
                    <p class="text-base ">*Campos obligatorios</p>
