import ModeloAdminRow from '@/components/ModeloAdminRow';
...
export default function ModelosAdmin() {
    const { marcas, modelos } = usePage().props;
    ...
    const handleSubmit = (e) => {
        ...
        post(route('admin.modelos.store'), {
            preserveScroll: true,
            onSuccess: () => {
            ...
            <div className="flex w-full flex-col p-6">
                ...
                <div className="mx-auto flex w-full flex-col gap-3">
                    ...
                    <div className="flex w-full justify-center">
                        <table className="w-full border text-left text-sm text-gray-500 rtl:text-right dark:text-gray-400">
                            ...
                            <tbody className="text-center">
                                {modelos?.data?.map((modelo) => <ModeloAdminRow key={modelo.id} modelo={modelo} />)}
                            </tbody>
                        </table>
                    </div>
                            ...
                            <div className="flex items-center">
                                {modelos.links.map((link, index) => (
                                    <button
                                        ...
                                        } ${index === 0 ? 'rounded-l-md' : ''} ${index === modelos.links.length - 1 ? 'rounded-r-md' : ''}`}
                    ...
                    <div className="mt-2 text-center text-sm text-gray-600">
                        Mostrando {modelos.from || 0} a {modelos.to || 0} de {modelos.total} resultados
                    </div>
                </div>
            </div>
        </Dashboard>
