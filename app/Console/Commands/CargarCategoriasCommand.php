...
class CargarCategoriasCommand extends Command
{
    protected $signature = 'categorias:cargar {archivo}';
    protected $description = 'Cargar categorías desde un archivo Excel';
    ...
    public function handle()
    {
        ...
        CargarCategoriasJob::dispatch($archivo);
